...
c) The legend isn't a very good position, change it to either the top left or outside of the graph. Hint: If you doin't like the position of the legend outside the graph, using `legend.outside.position` to change it.
```{r, fig.keep='none', message = FALSE}
tm_shape(ukgeom) +
  tm_fill(col = "pop_2017") +
  tm_borders() +
